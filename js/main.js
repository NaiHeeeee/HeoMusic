...
var heo = {
  ...
  getCustomPlayList: function () {
    ...
    if (params.get("id") && params.get("server")) {
      ...
      heoMusicPage.innerHTML = `<meting-js id="${id}" server="${server}" type="${playlistType}" mutex="true" preload="auto" order="circulation"></meting-js>`;
    } else {
      console.log("无自定义内容")
      heoMusicPage.innerHTML = `<meting-js id="${userId}" server="${userServer}" type="${userType}" mutex="true" preload="auto" order="circulation"></meting-js>`;
    }
  },
